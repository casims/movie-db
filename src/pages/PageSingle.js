...
const PageSingle = () => {
  useEffect(() => {     //this is for page tab title
  ...
  useEffect(() => {  //get the response from server and use json() to parse this response
  ...
  useEffect(() => { //get the trailer video key from a list of videos
